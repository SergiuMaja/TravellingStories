...
import { DestinationService } from "./stories/destination.service";
...
@NgModule({
  ...
  providers: [AuthService, UserService, AuthGuard, StoryService, DescriptionService, DestinationService, Globals],
